...
class PublicLandAppSub1 extends Component {
    render(){
        ...
        <tbody>
            ...
            <tr>
                ...
                <td id="description2" colspan="4" rowspan="4">
                    <p class="MsoNormal">
                        本案基地正面路寬為<u>{this.props.GroundWidth}</u>公尺，依新北市畸零地使用規則第<u>{this.props.Rule}</u>條規定，最小寬度為<u>{this.props.Width }</u>公尺，最小深度為<u>{this.props.Depth}</u>公尺。
                    </p>
                </td>
            </tr>
            <tr>
...
export default PublicLandAppSub1