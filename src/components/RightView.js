    ...
    renderSwitch = (key) => {
        switch (key) {
            case '建造執照申請':
                ...
                <Col xs={12} md={6}>
                    <PanelView title="貳、相關法令及規定：" body="一、 建築法第三十四條。　　二、 新北市建築管理規則。 
　　三、 山坡地建築管理辦法。" />
                </Col>
                </Row>
                <Row>
                <Col sm={12} md={12}>
                <PanelView title="參、民眾應附證件、書表、表單、附件： " body="一、建造執照申請書、雜項執照申請書、變更設計申請書(請至全國建築管理資訊系統入口網http://cpabm.cpami.gov.tw/index.jsp下載表單)。 
...
四十七、其他相關（證明）文件資料。" />
              ...
              <Row>
                  ...
                  <Col xs={6} md={6}>
                  <PanelView title="檔案下載" body="流程圖說明：如後附件。" />
                  </Col>
              </Row>
              </React.Fragment>)
